/****Main testing insert, find, findAll, delete & delete all ***/
...
int main(void){
  ...
  findResult = testHash.deleteFirst(77);
  cout << findResult.first << " " << findResult.second << endl;
  findResult = testHash.deleteFirst(77);
  cout << findResult.first << endl;
  testHash.insert(77,87);
  findResult = testHash.deleteFirst(77);
  cout << findResult.first << " " << findResult.second << endl;

  pair<int,list<int> > findResults =  testHash.deleteAll(13);
